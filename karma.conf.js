...
module.exports = function(config) {
    ...
    config.set({
        ...
        files: [
            ...
            { pattern: 'node_modules/dygraphs/dist/!(spec).*', included: false },
            { pattern: 'node_modules/d3/build/!(spec).*', included: false },
            { pattern: 'node_modules/nvd3/build/!(spec).*', included: false }
        ],
        preprocessors: {
            'modules/*.js': 'coverage'
        },
